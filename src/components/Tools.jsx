...
function Tools() {
    return (
        ...
        <p className="text-xm w-[70%]  text-gray-600 mb-5">Easily  integrate it with your WMS (Warehouse Management System) or OMS (Order Management System) to maintain efficiency and create video los for your customers </p>

       <Link to="/contact" className="flex hover:text-[#041558] mt-5">
