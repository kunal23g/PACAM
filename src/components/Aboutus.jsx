...
function Aboutus() {
    return (
        ...
        <div className='bg-[#F9F3EE]   flex flex-col p-5 md:p-10 lg:px-[70px]'>
            <div className='justify-between text-justify  lg:flex '>
                <h1 className=' text-5xl lg:text-6xl  text-[#041558] font-bold '><span className="  text-xs  text-neutral-500 font-light pl-1">ABOUT US <br /></span  > Our Story </h1>
                <p className=" my-4 p-1 lg:my-0  lg:p-9 text-xm  lg:text-lg   text-[#4F4F4F] max-w-2xl  ">At Pacam, our Recorder program is designed to help you start recording immediately, reducing cost losses by resolving claims, and enhancing your brand value and customer satisfaction.</p>
            </div>
            ...
            <div className='md:grid grid-cols-2  p-4 md:p-5  lg:px-[50px]'>
                <div className=" pl-3 col-span-1  flex flex-col ">
                    <h1 className=' pt-2  text-3xl border-b pb-5 border-black mb-7 font-bold'>Who we Are</h1>
                    <p className='  text-md w-[80%]   text-[#4F4F4F] font-light' >  We're on a mission to revolutionize the way business ooperatoe in teh digital landscape
                    </p>
                </div>
                <div className=" pl-3  col-span-1  flex flex-col ">
                    <h1 className=' pt-2  text-bottom text-xl border-b pb-7 border-black mb-7 '>Founded 2014</h1>
                    <p className='text-md text-justify pr-5  text-[#4F4F4F] font-light' > 
...
{/* aim */}
<div className=" p-2 bg-indigo-200 bg-opacity-20  lg:mx-[70px]  my-20   md:grid grid-cols-2 ">

<div className="  p-6 col-span-1">
            <img src={aboutaim} alt="package" />
        </div>

        <div className=" pl-5 col-span-1  flex flex-col justify-center ">
        <h1 className="text-3xl  text-dark-blue mb-4 ">What We Aim For</h1>

        <ul className=' text-justify text-[#4F4F4F] w-[80%]' >
            <li className=" flex mb-2 text-md  text-justify" >
            At Pacam, we envision a digital landscape where organizations of all sizes can
            harness the power of technology to unlock their full potential. By fostering a
...
<div className="   bg-[#F9F3EE]  my-20   md:grid grid-cols-3 ">
        ...
        <h6 className=" text-xs text-gray-600 mb-2 ">INSPIRE EXCELLENCE</h6>
        <h1 className=" text-3xl font-bold text-dark-blue mb-4 ">Innovation & <br /> Empowerment</h1>
        <p className=" text-xm w-[80%] text-gray-600 mb-5">Through cutting-edge technology and forward-
