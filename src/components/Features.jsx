...
const Features=({optimized,management})=> {
    ...
    const refCloudSolutions = useRef(null);
    const refManagement = useRef(null);
  
    // State to track visibility
    const [isVisibleCloudSolutions, setIsVisibleCloudSolutions] = useState(false);
    const [isVisibleManagement, setIsVisibleManagement] = useState(false);
  
    // Observer for Optimized Cloud Solutions section
    useEffect(() => {
      const observerCloudSolutions = new IntersectionObserver(
        ([entry]) => {
          if (entry.isIntersecting) {
            setIsVisibleCloudSolutions(true);
          }
        },
        {
          threshold: 0.1
      ...
      if (refCloudSolutions.current) {
        observerCloudSolutions.observe(refCloudSolutions.current);
      }
  
      return () => {
        if (refCloudSolutions.current) {
          observerCloudSolutions.unobserve(refCloudSolutions.current);
        }
      };
    }, []);
  
    // Observer for Management section
    useEffect(() => {
      const observerManagement = new IntersectionObserver(
        ([entry]) => {
          if (entry.isIntersecting) {
            setIsVisibleManagement(true);
          }
        },
        {
          threshold: 0.1
      ...
      if (refManagement.current) {
        observerManagement.observe(refManagement.current);
      }
  
      return () => {
        if (refManagement.current) {
          observerManagement.unobserve(refManagement.current);
        }
      };
    }, []);
  ...
  {/* Heading Section */}
  <h1 className=" mt-9 md:mt-18 text-4xl font-playfair font-medium sm:text-6xl lg:text-7xl text-center  tracking-wide">
      ...
      <p className="mt-12 font-playfair text-lg text-center text-neutral-500 ">
  ...
  <div className="grid p-5  justify-center justify-around lg:max-w-[1240px] lg:mx-auto grid-cols-1 lg:grid-cols-4 md:grid-cols-2 gap-10 mt-12 ">
    ...
    <div className="bg-white p-6 hover:scale-105 duration-500 rounded-lg shadow-lg  text-center">
      ...
      <h2 className="text-lg font-semibold font-playfair ">Auto-Record</h2>
    </div>
    ...
    <div className="bg-white p-6 hover:scale-105 duration-500 rounded-lg shadow-lg  text-center">
      ...
      <h2 className="text-lg font-semibold font-playfair">Access Your Videos <br /> on the Go</h2>
    </div>
    ...
    <div className="bg-white p-6 hover:scale-105 duration-500 rounded-lg shadow-lg  text-center">
      ...
      <h2 className="text-lg font-semibold font-playfair">Send with Ease</h2>
    </div>
    ...
    <div className="bg-white p-6 hover:scale-105 duration-500 rounded-lg shadow-lg  text-center">
      ...
      <h2 className="text-lg font-semibold font-playfair ">Seamless <br /> Integration</h2>
    </div>
  </div>
</div>
...
<div className=' mb-20 lg:mx-16'>
      ...
      <div ref={refCloudSolutions} className="p-10 mb-20 lg:p-[65px] my-20 gap-5 lg:gap-0 md:grid grid-cols-2">
        ...
        <m.div
          ...
          animate={isVisibleCloudSolutions ? { opacity: 1, scale: 1 } : {}}
...
{/* Management Section */}
<div ref={refManagement} className="p-10 bg-indigo-200 bg-opacity-20 my-20 md:grid grid-cols-3">
  <m.div
...
<div className="my-20 grid grid-cols-1 lg:grid-cols-7">
      <div className="col-span-4 justify-around bg-[#F7EFE5] p-6 lg:p-16">
        <h1 className="text-4xl lg:text-5xl font-playfair font-bold text-[#041558] mb-6 lg:mb-10">
...
<div className="md:grid grid-cols-3 gap-5 p-2 px-3">
  ...
  <h1 className=" mb-2 text-xs font-playfair font-medium  text-neutral-500 font-light pl-1">EFFORTLESS ONBOARDING</h1>
  <h1 className='text-2xl font-playfair font-medium lg:text-3xl mb-4'>Get Going Quickly and Easily</h1>
  ...
  <div className="flex flex-col p-4  shadow-xl  my-3 hover:scale-105 duration-500 ">
  <h1 className=" mb-2 text-xs font-playfair font-medium  text-neutral-500 font-light pl-1">TOOLS AND UPKEEP</h1>
  <h1 className='text-2xl font-playfair font-medium  lg:text-3xl mb-4'>Move Equipment with Ease</h1>
  ...
  <div className="flex flex-col p-4  shadow-xl  my-3 hover:scale-105 duration-500 ">
  <h1 className=" mb-2 text-xs font-playfair font-medium text-neutral-500 font-light pl-1">SUPPORT CENTER</h1>
  <h1 className='text-2xl font-playfair font-medium lg:text-3xl mb-4'>All-Day, Every Day support</h1>
...
<div className='lg:max-w-[1380px] lg:mx-auto py-10 items-center mb-14  flex flex-col bg-[#F3E2D3] '>
        ...
        <h1 className="text-2xl md:text-3xl lg:text-5xl text-dark-blue font-playfair font-medium text-center">Enhance Your Work Efficiency </h1>

        </div>
        <div className='  md:justify-center '>
         <Link to="/contact"  className=" rounded-md flex font-playfair   justify-center py-[1rem] px-[1rem] mt-5    text-white bg-black">
