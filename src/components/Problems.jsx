...
import pb3 from "../assets/Problems3.png"
 ...
 const Problems=()=>{
    return(
        <div className=" max-w-[1240px] mx-auto py-20 flex flex-col px-2  ">
            ...
            <div className="text-center font-bold mb-6">
                <h1 className="text-[50px] font-Inter text-[#041558]"><span className="text-black font-bold text-[50px]">PACAM</span> Ultimate <br />Problem-Solver for Everyone</h1>
            </div>
  ...
  <div className="flex flex-col   shadow-xl  my-3 hover:scale-105 duration-500 ">
    ...
    <h1 className="pl-3 font-bold text-indigo-950 text-2xl mb-5">Minimize Customer Queire</h1>

    <h1 className="pl-3 pr-[50px] mb-20 lg:text-base text-gray-600 text-justify">
  ...
  <div className="flex flex-col   shadow-xl  my-3 hover:scale-105 duration-500 ">
    ...
    <h1 className="pl-3 font-bold text-indigo-950 text-2xl mb-5">Keeping Claims in Check</h1>
  ...
  <div className="flex flex-col   shadow-xl  my-3 hover:scale-105 duration-500 ">
    ...
    <h1 className="pl-3 font-bold text-indigo-950 text-2xl mb-5">Discover Video Library</h1>
