  ...
  const [activeButton, setActiveButton] = useState(1)
    ...
    return (
      ...
      <div className="col-span-1 lg:col-span-4 justify-between bg-[#F7EFE5] p-6 lg:p-16">
        <div className="mt-10 flex flex-nowrap justify-between gap-2">
        ...
        <ul className="flex flex-col  justify-center p-5 lg:p-6 mt-10">
          {Li.map((item, index) => (
        ...
        <button className="flex mt-5 py-4 px-6 hover:bg-[#041558] hover:text-white rounded-md bg-transparent">
          Learn More
