...
const Testimonials = () => {
    return (
        ...
        <h6 className="text-xs text-gray-600 mb-2 ">Marketing : Enhance branding</h6>
        <h1 className="text-2xl font-bold text-dark-blue mb-4 ">Boost Your Brand's Personality</h1>
        <p className="text-xs text-gray-600 mb-5">Deliver every customer experience uniquely unforgettable.</p>
